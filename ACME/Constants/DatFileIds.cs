...
namespace ACME.Constants
{
    ...
    public static class DatFileIds
    {
        ...
        public const uint PaletteId = 0x0F000000; // Palette range start (Renamed from PaletteTableId)
        ...
        public const uint RenderMaterialId = 0x16000000; // RenderMaterial range start (Corrected ID, was 0x1A000000). NOTE: Same start as QualityFilter!
